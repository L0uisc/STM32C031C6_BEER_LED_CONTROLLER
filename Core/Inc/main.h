...
/* Private defines -----------------------------------------------------------*/
#define GROUP6_R_Pin GPIO_PIN_13
#define GROUP6_R_GPIO_Port GPIOC
...
#define GROUP2_R_Pin GPIO_PIN_4
#define GROUP2_R_GPIO_Port GPIOA
#define GROUP5_B_Pin GPIO_PIN_5
#define GROUP5_B_GPIO_Port GPIOA
...
#define GROUP8_R_Pin GPIO_PIN_0
#define GROUP8_R_GPIO_Port GPIOB
...
#define GROUP10_B_Pin GPIO_PIN_12
#define GROUP10_B_GPIO_Port GPIOB
...
#define GROUP6_G_Pin GPIO_PIN_6
#define GROUP6_G_GPIO_Port GPIOC
#define GROUP6_B_Pin GPIO_PIN_7
#define GROUP6_B_GPIO_Port GPIOC
#define GROUP7_G_Pin GPIO_PIN_10
#define GROUP7_G_GPIO_Port GPIOA
...
#define GROUP3_R_Pin GPIO_PIN_6
#define GROUP3_R_GPIO_Port GPIOB
#define GROUP4_R_Pin GPIO_PIN_7
#define GROUP4_R_GPIO_Port GPIOB
